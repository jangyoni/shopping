      ...
      <div class="row py-4 pb-0 pb-sm-4 align-items-center ">
        ...
        <div
          ...
          <div class="support-box text-end d-none d-xl-block">
            ...
            <h5 class="mb-0">010-6215-6507</h5>
          </div>
          <div class="support-box text-end d-none d-xl-block">
            <span class="fs-6 secondary-font text-muted">Email</span>
            <h5 class="mb-0">yhyh6507@gmail.com</h5>
          </div>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body justify-content-between">
            ...
            <ul class="navbar-nav menu-list list-unstyled d-flex gap-md-3 mb-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="pages">
                  ...
                  <li><a href="faqs.html" class="dropdown-item">FAQs<span
                        class="badge bg-success text-dark ms-2">PRO</span></a></li>
                  <li><a href="home1" class="dropdown-item">Account<span
                        class="badge bg-success text-dark ms-2">PRO</span></a></li>
              ...
              <li class="nav-item">
                <a href="list" class="nav-link fw-bold text-dark" target="_blank" style="font-family: 'HSSanTokki20-Regular';">후기게시판</a>
              </li>
            </ul>
      ...
      <div class="products-carousel swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="/resources/images/item2.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="/resources/images/item3.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="/resources/images/item4.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="/resources/images/item7.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="/resources/images/item8.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
    ...
    <div class="container my-5 py-5">
      ...
      <div class="isotope-container row">
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="/resources/images/item9.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="/resources/images/item10.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="/resources/images/item11.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="/resources/images/item12.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item bird col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="/resources/images/item13.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item bird col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="/resources/images/item14.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="/resources/images/item15.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="/resources/images/item16.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
    ...
    <div class="container">
      <div class="row flex-row-reverse banner-content align-items-center">
        <div class="img-wrapper col-12 col-md-6">
          <img src="/resources/images/banner-img2.png" class="img-fluid">
        </div>
        <div class="content-wrapper col-12 offset-md-1 col-md-5 p-5">
          <div class="secondary-font text-primary text-uppercase mb-3 fs-4">fuckyou</div>
          <h2 class="banner-title display-1 fw-normal" style="font-family: 'HSSanTokki20-Regular';">용품후기<br>쓰러가기
          </h2>
          <a href="review" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">
            review now
            <svg width="24" height="24" viewBox="0 0 24 24" class="mb-1">
              <use xlink:href="#arrow-right"></use>
            </svg></a>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="row ">
                  ...
                  <div class="col-md-10 mt-md-5 p-5 pt-0 pt-md-5">
                    <p class="testimonial-content fs-2">장여니는 기여웅</p>
              ...
              <div class="swiper-slide">
                <div class="row ">
                  ...
                  <div class="col-md-10 mt-md-5 p-5 pt-0 pt-md-5">
                    <p class="testimonial-content fs-2">장여니는 머싯성</p>
                    <p class="text-black">- Joshima Lin</p>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="row ">
                  ...
                  <div class="col-md-10 mt-md-5 p-5 pt-0 pt-md-5">
                    <p class="testimonial-content fs-2">장여니는 짱이야</p>
                    <p class="text-black">- Joshima Lin</p>
                  </div>
                </div>
              </div>
      ...
      <div class=" swiper bestselling-swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="/resources/images/item5.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="/resources/images/item6.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
