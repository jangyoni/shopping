    ...
    <div class="container">
        ...
        <form action="updateReview" method="post">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <th>제목</th>
                    <td><input type="text" name="title" value="${review.title}" class="form-control" required></td>
                </tr>
                <tr>
                    <th>내용</th>
                    <td><textarea name="content" class="form-control" required>${review.content}</textarea></td>
                </tr>
                <tr>
                    <th>글쓴사람</th>
